class CollisionDetectorTest {
    ...
    private static double runTest(int iterations, Double maxDist) {
        ...
        for (int i = 0; i < iterations; i++) {
            Sat.Vector[] tank = {new Sat.Vector(195.0, 95.0), new Sat.Vector(205.0, 95.0), new Sat.Vector(205.0, 105.0),
                    new Sat.Vector(195.0, 105.0)};
            Sat.Vector[] shell = {new Sat.Vector(99.5, 99.5), new Sat.Vector(100.5, 99.5), new Sat.Vector(100.5, 100.5),
                    new Sat.Vector(99.5, 100.5)};
